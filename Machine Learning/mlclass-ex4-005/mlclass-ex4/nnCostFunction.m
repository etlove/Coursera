...
% Set yk according to the num_lables
yk = eye(num_labels)(y,:);
...
% Calculate delta3, delta2
delta3 = h - yk;

delta2_1 = delta3 * Theta2;
delta2_2 = [ones(size(z2, 1), 1) sigmoidGradient(z2)];
delta2 = delta2_1 .* delta2_2;

% Calculate theta_grad (no reg)
